...
<div class="property-form">
    ...
    <div class="col-sm-4">
      <?= $form->field($model, 'building_sell')->textInput()->label('نحوه فروش') ?>
    </div>

    <div class="col-sm-4">
      <?= $form->field($model, 'activities_product')->textInput()->label('نوع فعالیت') ?>
    </div>
    ...
    <div class="col-sm-12">
      <div class="table-responsive property_table">
         <table class="table table-bordered">
           ...
           <tbody>
             <tr>
               <td><?= $form->field($model, 'balcony_area')->textInput()->label(false) ?></td>
